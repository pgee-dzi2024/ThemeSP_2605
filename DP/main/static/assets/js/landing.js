(function ($) {
  ...
  $("#myonoffswitch24").on("click", function () {
    if (this.checked) {
      ...
      document
        ...
        .setAttribute(
          "href",
          "../assets/css/plugins/bootstrap/css/bootstrap.rtl.min.css"
        );
  ...
  $("#myonoffswitch23").on("click", function () {
    if (this.checked) {
      ...
      document
        ...
        .setAttribute(
          "href",
          "../assets/css/plugins/bootstrap/css/bootstrap.min.css"
        );
      var carousel = $(".owl-carousel");
      $.each(carousel, function (index, element) {
        // element == this
  ...
  function landingPageLocalstorage() {
    if (localStorage.getItem("vistartl")) {
      $("body").addClass("rtl");
    }
    if (localStorage.getItem("vistadarkMode")) {
      $("body").addClass("dark-mode");
    }
  }
