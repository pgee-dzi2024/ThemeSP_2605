"use strict";
!async function() {
    const o = document.querySelector(".kanban-update-item-sidebar"),
    ...
    function p(e, t, a, n, d) {
        ...
        return null == e ? " " : e.split(",").map(function(e, t, a) {
            ...
            return "<div class='avatar " + o + a + "'data-bs-toggle='tooltip' data-bs-placement='top'title='" + i[t] + "'><img src='" + l + "img/avatars/" + e + "' alt='Avatar' class='rounded-circle " + r + "'></div>"
        }).join(" ")
    }
    ...
    const v = new jKanban({
            ...
            click: function(e) {
                ...
                s.show(), o.querySelector("#title").value = a, o.querySelector("#due-date").nextSibling.value = n, $(".kanban-update-item-sidebar").find(i).val(d).trigger("change"), o.querySelector(".assigned").innerHTML = "", o.querySelector(".assigned").insertAdjacentHTML("afterbegin", p(r, !1, "sm", "0", e.getAttribute("data-members")) + "<div class='avatar avatar-sm'><span class='avatar-initial rounded-circle bg-label-secondary'><i class='bx bx-plus'></i></span></div>")
            },
            buttonClick: function(e, a) {
                const n = document.createElement("form");
                n.setAttribute("class", "new-item-form"), n.innerHTML = '<div class="mb-3"><textarea class="form-control add-new-item" rows="2" placeholder="Add Content" autofocus required></textarea></div><div class="mb-3"><button type="submit" class="btn btn-primary btn-sm me-2">Add</button><button type="button" class="btn btn-label-secondary btn-sm cancel-add-item">Cancel</button></div>', v.addForm(a, n), n.addEventListener("submit", function(e) {
                    e.preventDefault();
    ...
    k && k.forEach(function(e) {
        ...
        let d = "";
        null !== e.getAttribute("data-image") && (d = "<img class='img-fluid rounded-3 mb-2' src='" + l + "img/elements/" + e.getAttribute("data-image") + "'>"), e.textContent = "", void 0 !== e.getAttribute("data-badge") && void 0 !== e.getAttribute("data-badge-text") && e.insertAdjacentHTML("afterbegin", (t = e.getAttribute("data-badge"), a = e.getAttribute("data-badge-text"), "<div class='d-flex justify-content-between flex-wrap align-items-center mb-2 pb-1'><div class='item-badges'> <div class='badge rounded-pill bg-label-" + t + "'> " + a + "</div></div>" + m() + "</div>" + d + n)), void 0 === e.getAttribute("data-comments") && void 0 === e.getAttribute("data-due-date") && void 0 === e.getAttribute("data-assigned") || e.insertAdjacentHTML("beforeend", (t = e.getAttribute("data-attachments"), a = e.getAttribute("data-comments"), n = e.getAttribute("data-assigned"), e = e.getAttribute("data-members"), "<div class='d-flex justify-content-between align-items-center flex-wrap mt-2 pt-1'><div class='d-flex'> <span class='d-flex align-items-center me-2'><i class='bx bx-paperclip me-1'></i><span class='attachments'>" + t + "</span></span> <span class='d-flex align-items-center'><i class='bx bx-chat me-1'></i><span> " + a + " </span></span></div><div class='avatar-group d-flex align-items-center assigned-avatar'>" + p(n, !0, "xs", null, e) + "</div></div>"))
    });
    ...
    c && c.addEventListener("click", function() {
        ...
        o.querySelector(".ql-editor").firstElementChild.innerHTML = ""
    }), o && o.addEventListener("shown.bs.offcanvas", function() {
        [].slice.call(o.querySelectorAll('[data-bs-toggle="tooltip"]')).map(function(e) {
            return new bootstrap.Tooltip(e)
        })
    })
}();