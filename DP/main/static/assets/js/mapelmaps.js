	...
	$(".mapcontainer4").mapael({
		...
		plots: {
			'paris': {
				latitude: 48.8566,
				longitude: 2.3522,
				tooltip: { content: "France<br />Population: 500000000" } // Change country name to France
			},
			'newyork': {
				latitude: 40.7128,
				longitude: -74.0060,
				tooltip: { content: "United States<br />Population: 200001" } // Change country name to United States
			},
			'sanfrancisco': {
				latitude: 37.7749,
				longitude: -122.4194,
				tooltip: { content: "United States" } // Update country name if needed
			},
			'brasilia': {
				latitude: -15.8267,
				longitude: -47.9218,
				tooltip: { content: "Brazil<br />Population: 200000001" } // Change country name to Brazil
			},
			'roma': {
				latitude: 41.9028,
				longitude: 12.4964,
				tooltip: { content: "Italy" } // Update country name if needed
			},
			'miami': {
				latitude: 25.7617,
				longitude: -80.1918,
